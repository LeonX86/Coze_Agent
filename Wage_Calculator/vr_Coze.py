...
async def get_month_work_days(year: int, month: int, week_days: int = 5) -> dict:
    """
...
async def main(args: Args) -> Output:
    ...
    # 获取输入参数
    salary = params.get('salary', 0.0)
    start_time = params.get('start_time', 9.0)
    end_time = params.get('end_time', 18.0)
    week_days = params.get('week_days', 5)
    ...
    # 获取月份工作日信息
    days_info = await get_month_work_days(year, month_num, int(week_days))
